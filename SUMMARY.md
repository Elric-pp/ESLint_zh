...
* [易错点](./doc/chapter1/README.md)
    ...
    + [在in操作符左侧禁用!](./doc/chapter1/no-negated-in-lhs.md)
    + [禁止调用内置对象](./doc/chapter1/no-obj-calls.md)
    + [正则中禁用多个空格](./doc/chapter1/no-regex-spaces.md)
    + [禁用稀疏数组](./doc/chapter1/no-sparse-arrays.md)
